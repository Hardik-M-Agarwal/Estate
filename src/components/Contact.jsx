...
function Contact(){
    ...
    const onSubmit = async (event) => {
      ...
      formData.append("access_key", "29b33d17-60e0-4028-a92c-530197646763");
        ...
        className='text-center p-6 py-20 lg:px-32 w-full overflow-hidden' id='Contact'>
            ...
            <form className='max-w-2xl mx-auto text-gray-600 pt-8' onSubmit={onSubmit}>
                <div className='flex flex-wrap'>
                    ...
                    <input className='w-full border border-gray-300 rounded py-3 px-4 mt-2' type="text" name='Name' placeholder="Enter Your Name" required></input>
                    </div>

                    <div className='w-full md:w-1/2 text-left md:pl-4'>Your Email
                    <input className='w-full border border-gray-300 rounded py-3 px-4 mt-2' type="email" name='Email' placeholder="Enter Your Email" required></input>
                    </div>
